...
```
git clone https://github.com/tirami/tfw-frontend.git
cd tfw-frontend
```
...
In addition, since Protractor is built upon WebDriver we need to install this.  You can use the predefined script to do this:
...
to your repository and execute scripts such as building the app or running tests. The the app
